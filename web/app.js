...
function detectPlatform() { const ua = navigator.userAgent.toLowerCase(); const platform = navigator.platform.toLowerCase(); if (ua.includes("windows") || platform.includes("win")) return { label: "Windows", ext: ".exe", href: "https://github.com/berteyx/vault-zero/releases/download/vault-zero-v0.1.0/Vault.Zero.Windows.exe" }; if (ua.includes("mac") || platform.includes("mac")) return { label: "macOS", ext: ".dmg", href: "https://github.com/berteyx/vault-zero/releases/download/vault-zero-v0.1.0/Vault.Zero.macOS.dmg" }; return { label: "Linux", ext: ".AppImage", href: "https://github.com/berteyx/vault-zero/releases/download/vault-zero-v0.1.0/Vault.Zero.Linux.AppImage" }; }
function setupDownload() { const os = detectPlatform(); const primary = $("#primary-download"); primary.textContent = `Scarica per ${os.label} (${os.ext})`; primary.href = os.href; $("#download-menu a:nth-child(1)").href = "https://github.com/berteyx/vault-zero/releases/download/vault-zero-v0.1.0/Vault.Zero.Windows.exe"; $("#download-menu a:nth-child(2)").href = "https://github.com/berteyx/vault-zero/releases/download/vault-zero-v0.1.0/Vault.Zero.macOS.dmg"; $("#download-menu a:nth-child(3)").href = "https://github.com/berteyx/vault-zero/releases/download/vault-zero-v0.1.0/Vault.Zero.Linux.AppImage"; }
